...
from helpers.profile.profile import (
    USER_NAME, RECIPIENT_NAME, RECIPIENT_EMAIL, file_prefix,
)
...
def email_report(
    *,
    ...
    recipient_line = f"{greeting}, {RECIPIENT_NAME},\n\n" if RECIPIENT_NAME else f"{greeting},\n\n"
    ...
    try:
        ...
        mailto = f"mailto:{quote(RECIPIENT_EMAIL)}?subject={quote(subject)}&body={quote(body)}"
